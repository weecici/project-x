...
class TestOlapConfigDefaults:
    """OlapConfig should have correct defaults for local dev."""
...
class TestOlapConfigEnvOverrides:
    """OlapConfig fields should be overridable via env vars."""
